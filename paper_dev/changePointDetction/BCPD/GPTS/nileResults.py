...
if __name__ == '__main__':
    data = \
        np.genfromtxt(
            '/Users/dmarthal/Desktop/source/papers/Thesis/insurance/nile.txt', delimiter=',')
  ...
  # prec = 1
    ...
    # Normalize training insurance (and test insurance using mean and std from test insurance)
  ...
  # Train GPTS
    ...
    # Learn the hyperparameters on the training insurance
